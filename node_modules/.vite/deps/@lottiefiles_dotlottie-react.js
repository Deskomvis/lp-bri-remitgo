...
var L = class e2 {
  ...
  static observe(t2, n3) {
    var _a;
    e2._initializeObserver(), !e2._observedCanvases.has(t2) && (e2._observedCanvases.set(t2, n3), (_a = e2._observer) == null ? void 0 : _a.observe(t2));
  }
  static unobserve(t2) {
    var _a, _b;
...
var R = class e3 {
  ...
  static observe(t2, n3) {
    var _a;
    e3._initializeObserver(), !e3._observedCanvases.has(t2) && (e3._observedCanvases.set(t2, [n3, 0]), (_a = e3._observer) == null ? void 0 : _a.observe(t2));
  }
  static unobserve(t2) {
    var _a;
...
var ae = class {
  ...
  get duration() {
    var _a;
    return (((_a = this._dotLottieCore) == null ? void 0 : _a.duration()) ?? 0) / 1e3;
  }
  get canvas() {
    return this._canvas;
  }
...
var se = class {
  constructor() {
    r(this, `_workers`, /* @__PURE__ */ new Map()), r(this, `_animationWorkerMap`, /* @__PURE__ */ new Map()), r(this, `_eventHandlers`, /* @__PURE__ */ new Map()), r(this, `_rpcHandlers`, /* @__PURE__ */ new Map()), r(this, `_routeMessage`, (e5) => {
      ...
      let n3 = (_a = t2.result) == null ? void 0 : _a.instanceId;
      if (n3) {
...
var $ = class e4 {
  constructor(t2) {
    ...
    let i3 = { ...t2, renderConfig: { ...t2.renderConfig, devicePixelRatio: ((_a = t2.renderConfig) == null ? void 0 : _a.devicePixelRatio) || H(), freezeOnOffscreen: ((_b = t2.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true } };
  ...
  async _create(e5) {
    ...
    let { instanceId: n3 } = await this._sendMessage(`create`, { instanceId: this._id, config: { ...e5, canvas: t2 }, ...Z(this._canvas, ((_a = e5.renderConfig) == null ? void 0 : _a.devicePixelRatio) || H()) }, [t2]);
...
var o2 = ({ animationId: e5, autoplay: t2, backgroundColor: o3, className: s3, createDotLottie: c3, data: l3, dotLottieRefCallback: u3, layout: d3, loop: f2, mode: p2, playOnHover: m2, renderConfig: h2, segment: g2, speed: _2, src: v2, stateMachineConfig: y2, stateMachineId: b2, style: x2, themeData: S2, themeId: C2, useFrameInterpolation: w2, workerId: T2, ...E2 }) => {
  ...
  let M2 = (0, import_react.useCallback)((e6) => {
    var _a2, _b2;
    O2.current = e6, e6 ? D2.current = c3({ ...j2.current, canvas: e6 }) : ((_a2 = D2.current) == null ? void 0 : _a2.destroy(), D2.current = null), (_b2 = k2.current) == null ? void 0 : _b2.call(k2, D2.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a2, _b2;
    let e6 = (e7) => {
      var _a3, _b3;
      m2 && (e7.type === `mouseenter` && ((_a3 = D2.current) == null ? void 0 : _a3.play()), e7.type === `mouseleave` && ((_b3 = D2.current) == null ? void 0 : _b3.pause()));
    };
    return (_a2 = O2.current) == null ? void 0 : _a2.addEventListener(`mouseenter`, e6), (_b2 = O2.current) == null ? void 0 : _b2.addEventListener(`mouseleave`, e6), () => {
      var _a3, _b3;
      (_a3 = O2.current) == null ? void 0 : _a3.removeEventListener(`mouseenter`, e6), (_b3 = O2.current) == null ? void 0 : _b3.removeEventListener(`mouseleave`, e6);
    };
    ...
    var _a2, _b2;
    typeof (g2 == null ? void 0 : g2[0]) == `number` && typeof g2[1] == `number` ? (_a2 = D2.current) == null ? void 0 : _a2.setSegment(g2[0], g2[1]) : (_b2 = D2.current) == null ? void 0 : _b2.resetSegment();
  }, [g2]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setBackgroundColor(o3 ?? ``);
  }, [o3]), (0, import_react.useEffect)(() => {
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setRenderConfig(h2 ?? {});
  }, [JSON.stringify(h2)]), (0, import_react.useEffect)(() => {
    var _a2;
    typeof l3 != `string` && typeof l3 != `object` || ((_a2 = D2.current) == null ? void 0 : _a2.load({ data: l3, ...j2.current }));
    ...
    var _a2;
    ((_a2 = D2.current) == null ? void 0 : _a2.isLoaded) && D2.current.activeAnimationId !== e5 && D2.current.loadAnimation(e5 ?? ``);
    ...
    var _a2;
    (_a2 = D2.current) == null ? void 0 : _a2.setLayout(d3 ?? {});
  }, [d3 == null ? void 0 : d3.fit, (_a = d3 == null ? void 0 : d3.align) == null ? void 0 : _a[0], (_b = d3 == null ? void 0 : d3.align) == null ? void 0 : _b[1]]), (0, import_react.useEffect)(() => {
    var _a2;
